...
$svg_triple_up = '<svg viewBox="0 0 24 24" width="100" height="100">
	<path style="fill:none;stroke:#4cc2ff;" d="m5 10 7-7 7 7" />
	<path style="fill:none;stroke:#ffffff;" d="m19 15.5-7-7-7 7" />
	<path style="fill:none;stroke:#4cc2ff;" d="m19 21-7-7-7 7" />
</svg>'
$svg_triple_down = '<svg viewBox="0 0 24 24" width="100" height="100">
	<path style="fill:none;stroke:#4cc2ff;" d="m19 14-7 7-7-7" />
	<path style="fill:none;stroke:#ffffff;" d="m5 8.5 7 7 7-7" />
	<path style="fill:none;stroke:#4cc2ff;" d="m5 3 7 7 7-7" />
</svg>'
$svg_triple_left = '<svg viewBox="0 0 24 24" width="100" height="100">
	<path style="fill:none;stroke:#4cc2ff;" d="m10 19-7-7 7-7" />
	<path style="fill:none;stroke:#ffffff;" d="m15.5 5-7 7 7 7" />
	<path style="fill:none;stroke:#4cc2ff;" d="m21 5-7 7 7 7" />
</svg>'
$svg_triple_right = '<svg viewBox="0 0 24 24" width="100" height="100">
	<path style="fill:none;stroke:#4cc2ff;" d="m14 5 7 7-7 7" />
	<path style="fill:none;stroke:#ffffff;" d="m8.5 19 7-7-7-7" />
	<path style="fill:none;stroke:#4cc2ff;" d="m3 19 7-7-7-7" />
</svg>'